export default function Page() {
    return (
      ...
      <div className="relative min-h-[50vh] w-full flex items-center justify-center align-middle" style={{backgroundImage: "url('/images/B6.webp')", backgroundSize: 'cover', backgroundPosition: 'center'}}>
      ...
      <div className="flex flex-col gap-4 items-center">
        ...
        <form className="max-w-[85%]">
            {/* TODO: add server action */}
            <div className="flex flex-wrap items-center justify-center max-h-8 gap-4">
                ...
                <button type="submit" className="bg-black text-white px-6 py-2 rounded-md hover:bg-gray-700 cursor-pointer transition duration-200">
                Reserve Table
            </button>
            </div>
